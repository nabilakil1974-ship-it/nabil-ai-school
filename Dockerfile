...
RUN python -m scripts.validate_nabil_ui \
    ...
    && python -m py_compile app/main.py app/api/routes_chat.py app/api/routes_worksheet.py app/api/routes_interactive_lessons.py app/api/routes_lesson_factory.py scripts/nabil_lesson_factory.py scripts/nabil_book_factory.py scripts/nabil_factory_worker.py scripts/start_server.py \
