...
def root():
    ...
    theme_css = '<link rel="stylesheet" href="/static/nabil_reference_theme.css?v=4">'
    html = html[:head_boundary] + direct_entry_css + theme_css + html[head_boundary:]

    scripts = (
        '<script src="/static/curriculum_strict.js?v=137"></script>\n'
        '<script src="/static/nabil_learning_v132.js?v=136"></script>\n'
        '<script src="/static/nabil_voice_v133.js?v=133"></script>\n'
        '<script src="/static/nabil_open_tutor_v1.js?v=4"></script>\n'
    )
