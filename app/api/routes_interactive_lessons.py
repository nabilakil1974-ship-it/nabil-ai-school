...
def view(grade: str, subject: str, lesson: str, language: str = "", trace: str = ""):
    ...
    try:
        ...
        if 'id="lesson-language"' in html and "</body>" in html.lower():
            html = re.sub(r"</body>", '<script src="/static/nabil_lesson_sticky_language_v1.js?v=1"></script><script src="/static/nabil_lesson_teacher_audio_v1.js?v=1"></script></body>', html, count=1, flags=re.I)
