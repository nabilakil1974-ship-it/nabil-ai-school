...
- نسّق شرح الدرس بعناوين قصيرة واضحة بهذا الترتيب عند ملاءمته: الفكرة أو المثال المحلول، المعطيات، القاعدة المستعملة، التعويض والحساب، الجواب النهائي، خلاصة القاعدة، سؤال تحقق.
...
- في الحلول المرئية رتّب الجواب بعناوين Markdown واضحة: ## المثال المحلول، ### 1. المعطيات، ### 2. القانون المستعمل، ### 3. التعويض والحساب، ### 4. الجواب النهائي، ### خلاصة القاعدة، ### سؤال تحقق. ترجم هذه العناوين إلى لغة الدرس المختارة.
