...
"""
    ...
    - بعد إنهاء جميع بطاقات الشرح والأمثلة والرسومات، أنشئ بطاقة واحدة مستقلة ونهائية. استخدم العنوان الموافق للغة الدرس فقط: العربية: ## البطاقة النهائية — خلاصة القاعدة ؛ English: ## Final Card — Rule Summary ؛ Français: ## Carte finale — Résumé de la règle.
    - البطاقة النهائية يجب أن تكون جامعة فعلًا لكل بطاقات الشرح السابقة، لا لآخر مفهوم فقط. راجع داخليًا كل عنوان ## سبقها، ثم لخص داخل البطاقة النهائية أهم فكرة/تعريف/قاعدة/نتيجة مثال أو رسم من كل جزء. إذا كان الدرس طويلًا، اجمع الأفكار المتقاربة لكن لا تسقط أي مفهوم رئيسي. يجوز استخدام 3 إلى 7 نقاط قصيرة داخل البطاقة النهائية حتى تكون شاملة وواضحة.
    - بعد البطاقة النهائية مباشرة اكتب سؤال تحقق واحد فقط بعنوان مستقل حسب اللغة: ## سؤال تحقق / ## Quick Check / ## Vérification rapide. ممنوع أن يتضمن عنوان سؤال التحقق عبارة "final card" أو "outside the final card" أو ترجمتها.
    - ترتيب نهاية الرد إلزامي: آخر بطاقة شرح أو مثال → البطاقة النهائية الجامعة → سؤال التحقق. ممنوع وضع أي شرح أو مثال جديد بعد سؤال التحقق.
    ...
    - في الحلول المرئية رتّب الجواب بعناوين Markdown واضحة: ## المثال المحلول، ## 1. المعطيات، ## 2. القانون المستعمل، ## 3. التعويض والحساب، ثم البطاقة النهائية الجامعة بعنوانها الموافق للغة الدرس. داخلها لخّص جميع الخطوات والقواعد والنتيجة والرسم الأساسي في نقاط قصيرة عند الحاجة، لا في جملة مبتورة. بعد ذلك فقط اكتب سؤال التحقق بعنوان مستقل. لا تكتب عبارة "outside the final card" داخل أي عنوان.
...
- هذه القاعدة عامة لكل درس أو فكرة حالية في جميع المواد، سواء كان نمط الشرح درسًا كاملًا أو فكرة ثم سؤال.
    ...
    - اختم شرح الدرس ببطاقة نهائية جامعة ومكتملة تجمع القواعد والأفكار الأساسية ونتائج الأمثلة والرسومات من جميع البطاقات السابقة بلغة الدرس، ولا تسمح بأن يتحول Quick Check إلى البطاقة النهائية.
    - إذا كانت طريقة الشرح interactive: اشرح فكرة واحدة ثم مثالًا ثم سؤال تحقق واحدًا وانتظر جواب الطالب.
    - إذا كانت طريقة الشرح full_lesson: اشرح جميع مفاهيم الدرس المطلوبة بترتيب واضح وفي عدد البطاقات اللازم حسب محتوى الدرس، من دون حد ثابت لعدد البطاقات، ثم أعط البطاقة النهائية الجامعة لكل ما سبق، ثم ابدأ التحقق أو الاختبار الختامي المناسب.
    """
