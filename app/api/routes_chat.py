...
"""
    ...
    - البطاقة النهائية ليست نسخة من البطاقات السابقة. لخّص جميع المفاهيم والقواعد ونتائج الأمثلة ومعاني الرسومات في 3 إلى 7 نقاط قصيرة فقط. لا تنسخ محتوى البطاقات أو الرسومات كاملة داخلها.
    ...
    - إذا كان الرسم مفيدًا، أرسل DRAWINGS_JSON مطابقًا للسؤال الحالي ولمستوى الصف بعدد الرسومات اللازمة فعلًا، من دون حد ثابت، ومن دون تكرار زخرفي.
...
- هذه القاعدة عامة لكل درس أو فكرة حالية في جميع المواد، سواء كان نمط الشرح درسًا كاملًا أو فكرة ثم سؤال.
    ...
    - اختم شرح الدرس ببطاقة نهائية واحدة فقط: 3–7 نقاط تلخّص القواعد والأفكار الأساسية ونتائج الأمثلة ومعاني الرسومات من جميع البطاقات السابقة، من دون نسخها كاملة، ويكون سؤال التحقق آخر جزء داخلها.
