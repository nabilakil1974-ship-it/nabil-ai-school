...
- اختم دائمًا بعنوان ## البطاقة النهائية — خلاصة القاعدة (واستخدم العنوان الموافق للغة الدرس المختارة فقط: العربية «البطاقة النهائية — خلاصة القاعدة»، English «Final Card — Rule Summary»، Français «Carte finale — Résumé de la règle»). هذه البطاقة هي خلاصة جامعة لكل بطاقات الشرح السابقة، لا لآخر مفهوم فقط. اجمع فيها: تعريف الدرس أو فكرته المركزية، القاعدة أو القانون الأساسي، ونتيجة المثال أو الرسم المستخدم في الدرس. اجعلها موجزة جدًا وواضحة، من دون فقرات طويلة، ومن دون وضع سؤال التحقق داخلها.
- بعد البطاقة النهائية مباشرة اكتب سؤال تحقق واحد فقط خارج البطاقة النهائية، ومن مستوى الدرس نفسه.
...
- اختم شرح الدرس ببطاقة نهائية واضحة تجمع القواعد والأفكار الأساسية ونتيجة المثال من جميع البطاقات السابقة بلغة الدرس.
