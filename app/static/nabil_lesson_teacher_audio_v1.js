...
function init(){
 ...
 const ar=[
 "انظروا، لدينا مقاومة لها طرفان. إذا بدّلنا الطرف الأول بالثاني، قيمة المقاومة لا تتغيّر. أي إن اتجاه مرور التيار لا يغيّر قيمة المقاومة الأومئة.",
 "الآن نغيّر التوتر ونقيس شدة التيار. بالناقل الأومي، كلما زاد التوتر زادت شدة التيار بالنسبة نفسها. قانون أوم هو U تساوي R ضرب I. انتبهوا إلى الوحدات: التوتر بالفولت، التيار بالأمبير، والمقاومة بالأوم.",
 "إذا أردنا قياس المقاومة مباشرة، نضع جهاز الملتيميتر على وضع الأوميتر، رمز أوميغا. يجب فصل التغذية الكهربائية قبل قياس المقاومة، ونقارن النتيجة مع R تساوي U على I.",
 "ماذا نلاحظ في الرسم؟ لدينا مقاومتين موصولتين على التوالي: R واحد تساوي مئتين وعشرين أوم، وR اثنين تساوي ثمانين أوم، ومصدر توتره اثنا عشر فولت. في التوصيل على التوالي، يمر التيار نفسه بالمقاومتين، والمقاومة المكافئة R E تساوي R واحد زائد R اثنين، أي مئتين وعشرين زائد ثمانين، النتيجة ثلاثمئة أوم. هلق نطبّق قانون أوم: I تساوي U على R E، أي اثنا عشر على ثلاثمئة، فنحصل على صفر فاصلة صفر أربعة أمبير، أو أربعين ميلي أمبير. ونتحقق أيضًا من أن U واحد زائد U اثنين يساوي اثنا عشر فولت.",
 "هنا يختلف التوصيل: المقاومتان على التفرّع. التوتر نفسه على كل فرع، أي U واحد تساوي U اثنين تساوي اثنا عشر فولت. التيار يتوزّع: I واحد تساوي اثنا عشر على مئتين وعشرين، وI اثنين تساوي اثنا عشر على ثمانين. المقاومة المكافئة R E نحسبها من واحد على R E تساوي واحد على R واحد زائد واحد على R اثنين. وبما أن لدينا مقاومتين، R E تساوي R واحد ضرب R اثنين على مجموعهما، أي مئتين وعشرين ضرب ثمانين على ثلاثمئة، فنحصل على تقريبًا ثمانية وخمسين فاصلة سبعة أوم. انتبهوا إلى الوحدات: بالموازي المقاومة المكافئة أصغر من كل مقاومة منفردة."
 ];
 const exerciseArabic={
  4:"التمرين أربعة. المعطيات: U تساوي اثنا عشر فولت، و I تساوي خمسة فاصلة خمسة ميلي أمبير. المطلوب نحسب المقاومة R. أولًا نحوّل الميلي أمبير لأمبير: I تساوي صفر فاصلة صفر صفر خمسة خمسة أمبير. من قانون أوم R تساوي U على I، أي اثنا عشر على صفر فاصلة صفر صفر خمسة خمسة، والنتيجة تقريبًا ألفين ومئة واثنين وثمانين أوم، أو اثنين فاصلة ثمانية عشر كيلو أوم.",
  6:"التمرين ستة. المعطيات: U تساوي أربعة وعشرين فولت، و R تساوي مئة أوم. المطلوب شدة التيار I. من قانون أوم I تساوي U على R، أي أربعة وعشرين على مئة، والنتيجة صفر فاصلة أربعة وعشرين أمبير.",
  7:"التمرين سبعة. المعطيات: I تساوي ميتين ميلي أمبير، و R تساوي واحد وخمسين أوم. المطلوب التوتر U. نحوّل التيار لصفر فاصلة اثنين أمبير، ونطبّق U تساوي R ضرب I، أي واحد وخمسين ضرب صفر فاصلة اثنين، والنتيجة عشرة فاصلة اثنين فولت.",
  14:"التمرين أربعة عشر. ما المعطيات؟ مقاومتين على التوالي، التوتر الكلي اثنا عشر فولت، R واحد مئتين وعشرين أوم، و U واحد ثمانية فاصلة ثمانية فولت. ما المطلوب؟ التيار I، والتوتر U اثنين، والمقاومة R اثنين. أولًا التيار I تساوي U واحد على R واحد، أي ثمانية فاصلة ثمانية على مئتين وعشرين، النتيجة صفر فاصلة صفر أربعة أمبير. ثانيًا U اثنين تساوي U ناقص U واحد، أي اثنا عشر ناقص ثمانية فاصلة ثمانية، النتيجة ثلاثة فاصلة اثنين فولت. ثالثًا R اثنين تساوي U اثنين على I، أي ثلاثة فاصلة اثنين على صفر فاصلة صفر أربعة، النتيجة ثمانين أوم.",
  15:"التمرين خمسة عشر. أولًا نقرأ المعطيات: لدينا مقاومتين على التوالي، R واحد تساوي مئة أوم، و R اثنين تساوي ميتين أوم، والتوتر الكلي U تساوي اثنا عشر فولت. المطلوب ثلاث كميات: المقاومة المكافئة R E، وشدة التيار I، والتوتر على المقاومة التانية U اثنين. الخطوة الأولى: R E تساوي R واحد زائد R اثنين، أي مئة زائد ميتين، فنحصل على ثلاثمئة أوم. الخطوة الثانية: I تساوي U على R E، أي اثنا عشر على ثلاثمئة، النتيجة صفر فاصلة صفر أربعة أمبير، أي أربعين ميلي أمبير. الخطوة الثالثة: U اثنين تساوي R اثنين ضرب I، أي ميتين ضرب صفر فاصلة صفر أربعة، فنحصل على ثمانية فولت. ونتحقق: التوتر على المقاومة الأولى أربعة فولت، وأربعة زائد ثمانية يساوي اثنا عشر فولت، كما في المعطيات."
 };
 ...
 function explanation(langOverride){
  ...
  if(row&&langOverride==="ar")return "نقرأ المعطيات والمطلوب أولًا، ونختار القانون المناسب، ونعوّض القيم مع وحداتها، ونتحقق من النتيجة.";
  const n=index(),t=(langOverride==="ar"?ar:select.value==="en"?en:fr)[n];
  if(t)return t;
  if(langOverride==="ar")return "اختر فقرة من أفكار الدرس الخمس، أو اسأل نبيل عن أي تمرين إضافي.";
 ...
 add("🇦🇪 اشرح بالفصحى",()=>{refresh();const t=explanation("ar");showExplanation(t,"rtl");speak(t,"ar-SA");});
